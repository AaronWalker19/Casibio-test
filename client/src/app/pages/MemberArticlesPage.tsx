...
export default function MemberArticlesPage() {
  ...
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full">
      <Navigation />
      <div className="bg-[#f3f3f5] content-stretch flex items-center justify-between px-[50px] py-[20px] relative shrink-0 w-full">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[48px] text-black whitespace-nowrap">
          Articles Membres
        </p>
        <Link
          to="/formulaire"
          className="bg-[#183542] content-stretch flex gap-[10px] items-center justify-center px-[20px] py-[10px] relative rounded-[4px] shrink-0"
        >
